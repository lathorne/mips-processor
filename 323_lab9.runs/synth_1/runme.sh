...
HD_PWD='J:/Documents/323_lab9/323_lab9.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mips_final.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mips_final.tcl
